...
if(!$fisherman) { redirect_to('../login.php'); }
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" value="<?php echo h($fisherman->username); ?>" disabled>
          </div>

          <div class="form-group">
            <label>ชื่อ-นามสกุล</label>
            <input type="text" class="form-control" value="<?php echo h($fisherman->full_name ?? ''); ?>" disabled>
          </div>

          <div class="form-group mb-0">
            <label>หมายเลขบัตรประชาชน / ทะเบียนนิติบุคคล</label>
            <input type="text" class="form-control" value="<?php echo h($fisherman->citizen_id); ?>" disabled>
            <small class="form-text text-muted">
              ข้อมูลส่วนนี้ไม่สามารถแก้ไขได้ หากมีการเปลี่ยนแปลง กรุณาติดต่อเจ้าหน้าที่
            </small>
          </div>

          <div class="form-group mb-0">
            <label>อีเมล</label>
            <input type="text" class="form-control" value="<?php echo h($fisherman->email ?? ''); ?>" disabled>
          </div>
