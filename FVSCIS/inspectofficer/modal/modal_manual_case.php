        ...
        <div class="modal-body">
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" name="request[owner_name]" required>
            </div>

            <!-- ทะเบียนเรือ -->
            <div class="col-md-3">
              <label class="form-label">ทะเบียนเรือ</label>
              <input type="text" class="form-control" name="request[ship_code]" required>
            </div>

            <!-- ชื่อเรือ -->
            <div class="col-md-3">
              <label class="form-label">ชื่อเรือ</label>
              <input type="text" class="form-control" name="request[vessel_name]" required>
            </div>
            ...
            <select name="request[port_tambon_id]" id="port_tambon_id" class="form-select" required>
                ...
                <?php
                // ✅ ดึงข้อมูลตำบลจากรหัสอำเภอที่ทราบ
            ...
            <!-- แนบไฟล์ -->
            <!--<div class="col-md-12">
              <label class="form-label">แนบไฟล์เอกสารหลักฐาน</label>
              <input type="file" class="form-control" name="attachments[]" multiple 
                     accept=".pdf,.jpg,.jpeg,.png,.doc,.docx">
              <div class="form-text text-muted">
                อัปโหลดได้หลายไฟล์ (pdf, doc, jpg, png)
              </div>
            </div>-->

            <div class="mb-12">
            <label class="form-label">แนบเอกสารหลักฐาน (pdf/jpg/png/doc, ≤10MB/ไฟล์)</label>
