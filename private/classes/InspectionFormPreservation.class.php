...
class InspectionFormPreservation extends DatabaseObject {
    ...
    public $status_5_1; public $fail_5_1_1;  public $remark_5_1;
    public $status_5_2; public $fail_5_2_1;  public $remark_5_2;
    ...
    public $status_5_5; public $fail_5_5_1; public $remark_5_5;
    public $status_5_6; public $fail_5_6_1; public $remark_5_6;
    ...
    public $status_5_9; public $fail_5_9_1; public $remark_5_9;
    ...
    public static $statusMap = [
            ...
            '5_3' => [
                ...
                'pass' => ['x' => 133, 'y' => 65],
                'fail' => ['x' => 147, 'y' => 65],
                'fails' => ['fail_5_3_1', 'fail_5_3_2'],
            ],
            '5_4' => [
                'page' => 3,
                'pass' => ['x' => 133, 'y' => 80],
                'fail' => ['x' => 147, 'y' => 80],
                'fails' => ['fail_5_4_1', 'fail_5_4_2'],
            ],
            '5_5' => [
                'page' => 3,
                'pass' => ['x' => 133, 'y' => 95],
            ...
            '5_7' => [
                ...
                'pass' => ['x' => 133, 'y' => 120],
                'fail' => ['x' => 147, 'y' => 120],
                'fails' => ['fail_5_7_1','fail_5_7_2'],
            ],
            '5_8' => [
                'page' => 3,
                'pass' => ['x' => 133, 'y' => 130],
                'fail' => ['x' => 147, 'y' => 130],
                'fails' => ['fail_5_8_1','fail_5_8_2'],
            ],
            '5_9' => [
                'page' => 3,
                'pass' => ['x' => 133, 'y' => 140],
