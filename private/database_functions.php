...
function db_fi_connect() {
	$dsn_fi = 'pgsql:host='.DB_SERVER_FI.';port='.DB_PORT_FI.';dbname='.DB_NAME_FI.";options='-c client_encoding=utf8'";
...
function db_el_connect() {
	$dsn_el = 'pgsql:host='.DB_SERVER_EL.';port='.DB_PORT_EL.';dbname='.DB_NAME_EL.";options='-c client_encoding=utf8'";
